...
namespace CardPile.Application.Services.OAuth.Tokens
{
    ...
    public class RefreshTokenClaims : TokenClaimsBase
    {
        ...
        public override ICollection<MetaData> GetMetaDataClaim() => this.MetaData;
    ...
    public class RefreshTokenSecretClaims
    {
        ...
        /// The Type of Token.
        /// </summary>
        public string TokenType => TokenTypes.RefreshToken;
